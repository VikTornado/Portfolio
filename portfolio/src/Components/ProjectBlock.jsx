            ...
            {props.state.map((item, id) => {
                return(
                    <div className={"relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 " +
                        "rounded-xl group hover:bg-gradient-to-r from-gray-300 to-[#001b5e]"}>
                        <img className={'h-full w-full rounded-xl group-hover:opacity-10 bg-cover bg-center'} key={id} src={item.image} alt=""/>
